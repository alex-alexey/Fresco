...
import type { PublicStorefrontData } from "@/lib/storefront"
import { StoreHero } from "@/app/(vendor)/[tenantSlug]/StoreHero"
import { StoreNavbar } from "@/app/(vendor)/[tenantSlug]/StoreNavbar"
import { StoreViewer } from "@/app/(vendor)/[tenantSlug]/StoreViewer"
...
export function PublicStorefront({ storefront }: { storefront: PublicStorefrontData }) {
  const { tenantSlug, store, primaryColor, hasContact } = storefront
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
              {store.products.map((product, index) => (
                <FadeIn key={product._id.toString()} delay={index * 0.05}>
                ...
                <div>
                  ...
                  <div className="rounded-2xl border border-gray-100 overflow-hidden">
                    {DAY_KEYS.map((key, index) => {
                      ...
                      return (
                        <div key={key}
                          className={`flex items-center justify-between px-5 py-4 ${index !== DAY_KEYS.length - 1 ? "border-b border-gray-50" : ""}`}
